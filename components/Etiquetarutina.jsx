...
import { Muscleman } from '../assets/Muscleman';
import { Colors } from '../assets/Colors';
import { LinearGradient } from 'expo-linear-gradient';


export const Etiquetarutina = () => {
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.titulo}>AGREGA TU PROPIA RUTINA</Text>
      <View  style={styles.container}>
        <Muscleman style={styles.img}/>
        <View style={styles.texte}>        
          <Text style={styles.texto}>
            Si ya tienes tu propia rutina, añade los ejercicios para dar seguimiento
          </Text>
          <TouchableOpacity>
            <LinearGradient colors={Colors.gradient} style={styles.btn}>
              <Text style={styles.txtbtn}>DISEÑA TU RUTINA</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      </View>
